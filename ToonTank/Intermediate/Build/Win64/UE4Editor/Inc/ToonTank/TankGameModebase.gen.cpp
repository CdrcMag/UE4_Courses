...
// Cross Module References
	TOONTANK_API UClass* Z_Construct_UClass_ATankGameModeBase_NoRegister();
	TOONTANK_API UClass* Z_Construct_UClass_ATankGameModeBase();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ATankGameModeBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ATankGameModeBase_GameOver, "GameOver" }, // 2036180472
		{ &Z_Construct_UFunction_ATankGameModeBase_GameStart, "GameStart" }, // 3790421919
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ATankGameModeBase, 593253637);
	template<> TOONTANK_API UClass* StaticClass<ATankGameModeBase>()
	{
		return ATankGameModeBase::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ATankGameModeBase(Z_Construct_UClass_ATankGameModeBase, &ATankGameModeBase::StaticClass, TEXT("/Script/ToonTank"), TEXT("ATankGameModeBase"), false, nullptr, nullptr, nullptr);
