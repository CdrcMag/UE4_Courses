...
// Cross Module References
	TOONTANK_API UClass* Z_Construct_UClass_APawnTank_NoRegister();
	TOONTANK_API UClass* Z_Construct_UClass_APawnTank();
...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APawnTank_Statics::NewProp_RotationSpeed_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Movement settings" },
		{ "ModuleRelativePath", "Pawns/PawnTank.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_APawnTank_Statics::NewProp_RotationSpeed = { "RotationSpeed", nullptr, (EPropertyFlags)0x0040000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APawnTank, RotationSpeed), METADATA_PARAMS(Z_Construct_UClass_APawnTank_Statics::NewProp_RotationSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APawnTank_Statics::NewProp_RotationSpeed_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_APawnTank_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APawnTank_Statics::NewProp_RotationSpeed,
	};
	...
	IMPLEMENT_CLASS(APawnTank, 3053818577);
	template<> TOONTANK_API UClass* StaticClass<APawnTank>()
	{
		return APawnTank::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_APawnTank(Z_Construct_UClass_APawnTank, &APawnTank::StaticClass, TEXT("/Script/ToonTank"), TEXT("APawnTank"), false, nullptr, nullptr, nullptr);
